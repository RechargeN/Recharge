...
- Target: [BCK-05 v0.2.17](BACKEND_DEPLOYMENT_OPERATIONS_SPEC.md)
- Coordination baseline: [BCK-02 v2.4.26](RECHARGE_BACKEND_DELIVERY_MAP.md)
...
| BCK-01 v0.4.22 | Review; local R0 scaffold Present, product/cloud runtime Absent | Parent architecture |
| BCK-02 v2.4.26 | Approved semantic baseline | Registry/gates/template |
...
| BCK-05 v0.2.17 | Draft; bounded R0 Pass, product/cloud runtime Absent; OD-01 Accepted; OD-02/03/04/05/07/08 Proposed | `BCK05-OD01-DEC-01` v0.2 records exact Acceptance; the R0 advisory exception does not propagate to R1; specialist evidence and every cloud/product gate remain pending |
...
BCK-05 v0.2.17 is structurally complete enough for specialist review preparation.
