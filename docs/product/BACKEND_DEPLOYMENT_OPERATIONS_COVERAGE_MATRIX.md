...
- Target: [BCK-05 v0.2.18](BACKEND_DEPLOYMENT_OPERATIONS_SPEC.md)
...
| BCK-01 v0.4.23 | Review; local R0 scaffold Present, product/cloud runtime Absent | Parent architecture |
| BCK-02 v2.4.27 | Approved semantic baseline | Registry/gates/template |
| BCK-03 v0.3.3 | Draft; runtime Absent | API/event input; split-key conflict closed, not Approved |
| BCK-04 v0.4.11 | Draft; runtime Absent; OD-01/09 Proposed; OD-07 decision-ready but unsigned | Security/privacy input, not Accepted |
...
| BCK-05 v0.2.18 | Draft; bounded R0 Pass, product/cloud runtime Absent; OD-01 Accepted; OD-02/03/04/05/07/08 Proposed | `OD07-A1-EU-MR-v1` is review-ready through evidence v0.5 and unsigned OD07-DEC-01 v0.1; OD-07 remains Proposed; specialist evidence and every cloud/product gate remain pending |
...
| BCK05-PRE-03 | OD-07 decision-ready but Proposed | Platform + Security/Privacy + Product/Finance | Exact OD07-DEC-01 owner verdict |
...
BCK-05 v0.2.18 is structurally complete enough for specialist review preparation.
