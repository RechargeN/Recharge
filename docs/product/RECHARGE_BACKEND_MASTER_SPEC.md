...
| Backend sequencing | [BCK-02 v2.4.28](RECHARGE_BACKEND_DELIVERY_MAP.md) | Сохранить registry, owners, OD, risks, D/R waves и G0–G7; v2.4 остаётся Approved semantic baseline, v2.4.1–2.4.28 — traceability amendments |
...
| Operations | BCK-05 v0.2.19 и coverage matrix v0.2.19 Draft/Present | Bounded R0 is Pass; BCK05-OD-01 and cross-domain OD-07 are Accepted; OD-02/03/04/05/07/08 and specialist/stage/restore/EUR/product-cloud evidence remain unresolved | Revalidate OD-07, close remaining blockers, and re-audit before R1 |
| Privacy | BCK-04 v0.4.12 и coverage matrix v0.3.12 Draft/Present | OD-07 engineering topology is Accepted while EU-resource/global-service boundaries, threat/incident models and tabletop package remain explicit; owner/independent/qualified Legal verdicts, executed result and DSR runtime remain absent | Закрыть BCK-04 blockers; OD-07 Acceptance не является Legal approval/runtime evidence |
...
## 25. Definition of Done BCK-01 v0.4.24
...
46. **BCK-01-AC-46:** BCK-02 v2.4.28 (Approved v2.4 semantics), BCK-02-A1
...
На дату v0.4.24 не реализованы:
