...
| Event Booking | ADR 0019 Accepted; ECL-03 v1.3/D01–D12 Approved/Accepted; BCK-09 v1.8 and coverage v1.7 Review/Present with 22/22 coverage; Booking-v1 API-DEC-01/03 Accepted with controls; BCK09-REV-01 v0.7 / API review v0.5 retain parity/evidence Hold; all nine signatures Pending; ECL-03B contracts/domain and BCK09-API-CORR-01 v0.3 Done; ECL-03C v1.6 exact nine-collection/47-AC plan Review | D12 command Schema/Dart parity and named Booking API decisions are resolved; TypeScript/query/hash/runtime parity, independent evidence, OD-09/11, Identity, Event projection, effects/repair seams and production evidence remain blocked; no authoritative runtime | Prepare a separately Approved contracts/test parity slice, then complete reviews/dependencies; only afterwards may a separately Approved ECL-03C runtime slice be considered |
...
46. **BCK-01-AC-46:** BCK-02 v2.4.50 (Approved v2.4 semantics), BCK-02-A1
    Draft v1.0 и BCK-09 Review v1.8 представлены с их фактическими
