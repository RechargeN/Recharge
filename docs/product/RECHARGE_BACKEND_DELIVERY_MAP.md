...
- Registry amendments: **2026-08-15, 2026-08-16, 2026-08-20, 2026-08-21,
  2026-08-24, 2026-08-25 and 2026-08-26, Product owner
...
## 5. Реестр проектных документов — 22 (v2.4.45)

| ID | Файл | Accountable owner | Уникальная область | Основные зависимости | Spec | Runtime |
|---|---|---|---|---|---|---|
| BCK-01 | `RECHARGE_BACKEND_MASTER_SPEC.md` | Platform Architecture | Target architecture, module boundaries, shared invariants | Accepted ADR, BCK-02, §3 anchors | Review v0.4.41 — Present | Local R0 tooling scaffold only; product/cloud Absent |
| BCK-02 | `RECHARGE_BACKEND_DELIVERY_MAP.md` | Architecture owner | Registry, ownership, dependencies, waves, risks and gates | Current repository facts | Approved v2.4 baseline; factual registry v2.4.45 | N/A |
...
BCK-09 v1.4 и его 22/22 coverage matrix v1.3 существуют как Review-документы:
...
ещё нужны девять независимых verdicts из BCK09-REV-01 v0.3; первый API
pre-review имеет technical Hold по BCK09-API-REV-01 v0.1; перед runtime —
