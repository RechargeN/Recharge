...
## 5. Реестр проектных документов — 22 (v2.4.23)

| ID | Файл | Accountable owner | Уникальная область | Основные зависимости | Spec | Runtime |
|---|---|---|---|---|---|---|
| BCK-01 | `RECHARGE_BACKEND_MASTER_SPEC.md` | Platform Architecture | Target architecture, module boundaries, shared invariants | Accepted ADR, BCK-02, §3 anchors | Review v0.4.19 — Present | Local R0 tooling scaffold only; product/cloud Absent |
| BCK-02 | `RECHARGE_BACKEND_DELIVERY_MAP.md` | Architecture owner | Registry, ownership, dependencies, waves, risks and gates | Current repository facts | Approved v2.4.23 | N/A |
...
| BCK-05 | `BACKEND_DEPLOYMENT_OPERATIONS_SPEC.md` | Platform Operations owner | Environments, projects/resources, CI/CD, server flags, SLO, operational monitoring, cost, backup/DR | BCK-01, BCK-04, environment policy, OD-07, OD-09 | Draft v0.2.14 — Present; OD-01/02/03/04/05/07/08 Proposed; bounded R0 approved and locally/hosted executed; Windows/Linux parity Pass; Moderate-advisory disposition and specialist evidence pending | Local R0 tooling scaffold only; product/cloud Absent |
...
Формальный prerequisite выполнен: `RECHARGE_BACKEND_MASTER_SPEC.md` v0.4.19
...
1. BCK-01 v0.4.19 Review с traceability/reconciliation к §3 и
   [`BCK-01-REV-01`](BACKEND_MASTER_RECONCILIATION_REPORT.md) owner evidence;
2. BCK-02 v2.4.23 traceability/checksum;
3. BCK-03 v0.3.3, BCK-04 v0.4.10, BCK-05 v0.2.14 и BCK-20 v0.2.2
