...
- Registry amendments: **2026-08-15, 2026-08-16, 2026-08-20, 2026-08-21,
  2026-08-24, 2026-08-25, 2026-08-26 and 2026-08-27, Product owner
...
## 5. Реестр проектных документов — 22 (v2.4.50)

| ID | Файл | Accountable owner | Уникальная область | Основные зависимости | Spec | Runtime |
|---|---|---|---|---|---|---|
| BCK-01 | `RECHARGE_BACKEND_MASTER_SPEC.md` | Platform Architecture | Target architecture, module boundaries, shared invariants | Accepted ADR, BCK-02, §3 anchors | Review v0.4.46 — Present | Local R0 tooling scaffold only; product/cloud Absent |
| BCK-02 | `RECHARGE_BACKEND_DELIVERY_MAP.md` | Architecture owner | Registry, ownership, dependencies, waves, risks and gates | Current repository facts | Approved v2.4 baseline; factual registry v2.4.50 | N/A |
| BCK-03 | `BACKEND_API_CONTRACT_STANDARD.md` | API Platform | Envelopes, typed errors, versioning, pagination, idempotency, event envelope, schema evolution, minimum client | BCK-01, API Contracts Workflow, OD-09 | Draft v0.3.4 — Present; Booking-v1 API-DEC-01/03 Accepted with controls | Absent |
...
BCK-09 v1.8 и его 22/22 coverage matrix v1.7 существуют как Review-документы:
...
ECL03-D12 и BCK09-API-CORR-01 закрывают parent semantics и command artifact
parity. Перед `Approved` всё ещё нужны девять независимых verdicts из
BCK09-REV-01 v0.7; BCK09-API-REV-01 v0.5 сохраняет Hold для
TypeScript/query/hash/runtime parity и independent evidence. Перед runtime
также необходимы отдельно Approved ECL-03C v1.6 и все
...
1. Ревизия v2.4.50 содержит 22 BCK-specs и 6 runbooks.
...
Формальный prerequisite выполнен: `RECHARGE_BACKEND_MASTER_SPEC.md` v0.4.46
...
3. BCK-03 v0.3.4, BCK-04 v0.4.16, BCK-05 v0.2.23 и BCK-20 v0.2.2
