...
| S1-DISC-01 | Sprint 1 | Discover Feed + Details (Read) | P0 | Planned | TBD |
| S1-CORE-01 | Sprint 1 | Core App Shell + Telemetry Wiring | P0 | Planned | TBD |
| S2-DISC-02 | Sprint 2 | Discover Search + Filters + Map Radius | P0 | Planned | TBD |
