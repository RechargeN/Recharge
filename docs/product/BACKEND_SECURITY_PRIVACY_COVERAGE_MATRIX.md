...
- Target document: [BCK-04 v0.4.13](BACKEND_SECURITY_PRIVACY_SPEC.md)
...
Revision v0.3.13 records the decision-ready `BCK05-IAM-A1-ENV-WIF-v1`
security boundary without treating its unsigned verdict as Acceptance. It
...
Draft; executable IAM/cloud, owner, qualified Legal/Privacy and executed/passed
tabletop evidence remain blocked.
...
| BCK-01 | Review v0.4.25, Present; local R0 scaffold only, product/cloud runtime Absent | Parent backend architecture и cross-cutting invariants |
| BCK-02 | Approved v2.4.29; runtime N/A | Registry, owners, dependencies, gates и обязательная структура |
| BCK-03 | Draft v0.3.3, Present; runtime Absent | API envelope/versioning/idempotency input, split-key conflict closed |
| BCK-05 | Draft v0.2.20, Present; local R0 scaffold only; BCK05-OD-01 and cross-domain OD-07 Accepted; BCK05-OD-02 decision-ready/Proposed; other listed BCK05 OD Proposed | Operations/IAM/OD-07/SLO/cost/recovery/numeric-review/incident evidence input, ещё не Approved |
...
| BCK-04 | Draft v0.4.13; runtime Absent; OD-01/09 Proposed; OD-07 Accepted with controls | Единственный target security/privacy contract |
...
| № | Требование `BCK-02 §14` | Покрытие BCK-04 v0.4.13 | Evidence / остаток |
|---:|---|---|---|
...
BCK-04 v0.4.13 структурно покрывает обязательный template и готов к предметному
