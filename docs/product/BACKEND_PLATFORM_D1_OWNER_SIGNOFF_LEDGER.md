...
- Review package: [BCK-D1-REV-01 v1.11](BACKEND_PLATFORM_D1_REVIEW_EVIDENCE_PACKAGE.md)
- Combined-owner workbook: [BCK-D1-OWN-REV-01 v1.8](BACKEND_PLATFORM_D1_COMBINED_OWNER_REVIEW_WORKBOOK.md)
- Runtime effect: **none**
...
| BCK-04 v0.4.14 | D1-SIG-SEC + D1-SIG-LEGAL where legal judgment applies | D1-SIG-OPS, domain owners | Assigned; OD-07 and BCK05-OD-02 Accepted with controls; broader review pending |
| BCK-05 v0.2.21 | D1-SIG-OPS | D1-SIG-SEC, D1-SIG-LEGAL, D1-SIG-FIN and affected domains | Draft retained; bounded R0 Pass, BCK05-OD-01/02 and cross-domain OD-07 Acceptance are Present; executable IAM and other OD/specialist/stage/product-cloud evidence remains pending |
