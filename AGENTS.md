...
Версия: 2026-08-28. Канонический файл инструкций репозитория.
...
| Event Classification v2.2.3 | Accepted canonical product/domain contract; 34 архетипа и Category System v1.4.3 coverage. ECL-00–ECL-03B Done. ECL-03A: ADR 0019 Accepted, ECL-03 v1.3 Approved и D01–D12 Accepted. BCK09-API-CORR-01 v0.3 и BCK09-API-PAR-01 v0.3 Done закрывают Booking-v1 Schema/Dart/TypeScript query/hash parity на exact Node 22.23.2; RAW-B v0.1 Done закрывает только disposable Emulator raw-body feasibility (19/19 Ubuntu/Windows vectors). ECL-03C-P v1.9 Review: пять callable surfaces, nine collections и 51 AC. BCK-09 v1.11 / coverage v1.10 Review/Present, runtime Absent; RAW-C v0.1 Proposed, не implementation authority. BCK09-REV-01 v0.10 сохраняет independent-evidence/runtime Hold; all nine signatures Pending. Нет client/network/repository/data/application/presentation/DI/Create/product-backend/Firebase runtime. Физическая реализация требует exact separate RAW-C/ECL-03C authorization, specialist verdicts и production prerequisites; provider sync/Payments не реализованы |
