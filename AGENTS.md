...
| Event Classification v2.2.3 | Accepted canonical product/domain contract; 34 архетипа и Category System v1.4.3 coverage. ECL-00–ECL-03B Done. ECL-03A: ADR 0019 Accepted, ECL-03 v1.3 Approved и D01–D12 Accepted; D12 задаёт opaque nonblank case-sensitive Booking request ID длиной 1–128 Unicode scalar values, без ULID-only правила. ECL-03B contracts/Dart domain green 9/9, но D12 Schema/Dart parity ещё не реализована. ECL-03C-P v1.4 Review: пять callable surfaces, nine collections, atomic active/idempotency keys и 47 AC. BCK-09 v1.6 / coverage v1.5 Review/Present, runtime Absent; BCK09-API-CORR-01 v0.2 и named API-DEC-01/03 остаются blockers. BCK09-REV-01 v0.5 retains narrowed API Hold; all nine signatures Pending. Нет client/network/repository/data/application/presentation/DI/Create/product-backend/Firebase runtime. Физическая реализация требует separate plan/runtime authorization, specialist verdicts и production prerequisites; provider sync/Payments не реализованы |
