...
Версия: 2026-08-27. Канонический файл инструкций репозитория.
...
| Event Classification v2.2.3 | Accepted canonical product/domain contract; 34 архетипа и Category System v1.4.3 coverage. ECL-00–ECL-03B Done. ECL-03A: ADR 0019 Accepted, ECL-03 v1.3 Approved и D01–D12 Accepted. `api_contracts` v0.2.1 / BCK09-API-CORR-01 v0.3 Done закрывают nine-command Schema/Dart/D12 parity: 13/13 package tests, независимые 14 valid / 38 invalid Draft 2020-12 vectors и зелёный общий mobile gate 664/664; Windows Route golden отделён от canonical non-Windows baseline при сохранённом exact layout guard. ECL-03C-P v1.5 Review: пять callable surfaces, nine collections, atomic active/idempotency keys и 47 AC. BCK-09 v1.7 / coverage v1.6 Review/Present, runtime Absent; named API-DEC-01/03 и TypeScript/query/runtime parity остаются blockers. BCK09-REV-01 v0.6 retains narrowed API Hold; all nine signatures Pending. Нет client/network/repository/data/application/presentation/DI/Create/product-backend/Firebase runtime. Физическая реализация требует separate plan/runtime authorization, specialist verdicts и production prerequisites; provider sync/Payments не реализованы |
